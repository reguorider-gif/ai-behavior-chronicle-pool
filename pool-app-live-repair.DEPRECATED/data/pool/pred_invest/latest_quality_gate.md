# PRED-INVEST Quality Gate · run-16

- date: 2026-06-16
- status: **PARTIAL_NOT_READY**
- publish allowed: False
- frontend badge: 10/12 部分回收
- valid seats: 10/12 (chatgpt, deepseek, doubao, gemini, kimi, meta, mimo, minimax, wenxin, yuanbao)
...
| qwen | fresh_chat_marker_required | ultra_compact | 未捕获当前轮答案或页面仍停留旧上下文，必须新会话/新 marker 重投。 |
